    ...
    data = {
        ...
        "variables": {
            "request": {
                ...
                "weightages": [
                    {
                        "experimentName": "ps-custom-chaos-lb1",
                        "weightage": 10
                    }
                ],
                "projectID": 'updated_project_id',
